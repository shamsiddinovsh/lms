...
function App() {
  ...
  // const handleToggle = (targetTime) => {
  //   setTimeCheckboxes((timeCheckBoxes) => {
  //     return timeCheckBoxes.map(({ time, isChecked }) => ({
  //       time,
  //       isChecked: targetTime === time.name ? !isChecked : isChecked
  //     }));
  //   });
  ...
  return (
    ...
    <div className="d-flex justify-content-between align-items-center">
      <h5 className="font-18 mb-3 text-muted font-weight-bold">Home Work</h5>
    </div>
    <div className="row">
